...
insert into typy_odpowiedzi values (0,'jednokrotne','jednokrotne odpowiedzi');
insert into typy_odpowiedzi values (1,'wielokrotne','wielokrotne odpowiedzi');
insert into typy_odpowiedzi values (2,'otwarte',' odpowiedz komentarz');

/* dodawanie pytan */
insert into pytania(id_typ_odpowiedzi, id_ankieta, kolejnosc, pytanie)
	values(1,1,1,'O którym z kandydatow na fotel prezydenta Białegostoku słyszałes(as)?');
insert into pytania(id_typ_odpowiedzi, id_ankieta, kolejnosc, pytanie)
	values(0,1,2,'Gdybys mial(a) mozliwosc na ktorego kandydata bys glosowal(a)?');
insert into pytania(id_typ_odpowiedzi, id_ankieta, kolejnosc, pytanie)
	values(2,1,3,'Napisz co slyszalas o kandydacie Krzysztofie Kononowiczu?');
...
insert into odpowiedzi(id_pytanie, id_wypelniona_ankieta, odpowiedz)
	values(2,1,'7'), (2,2,'7'), (2,3,'5'), (2,4,'5'), (2,5,'5');
